...
import Stock2 from "@/assets/images/About/stockimage2.svg";
            ...
            <div className="min-h-screen">
                ...
                <div className="flex flex-grow flex-wrap items-center overflow-hidden">
                    <div className="container space-y-8">
                        ...
                        <img src={Stock1} alt="Stock1" className="m-h-12 m-w-12 mx-auto space-y-8" />
                    </div>
                </div>
                <Heading
                    text="OUR MISSION"
                ...
                <div className="flex flex-wrap items-center relative">
                    <div className="space-y-8">
                        ...
                        <div className="flex flex-row items-center flex-grow px-64 py-8">
                            <img src={Stock2} alt="Stock1" className="max-h-96 max-w-96 mx-auto" />
                            <div className="w-24 h-24 rounded-full bg-background-light absolute top-60 right-48">
                                {}
                            </div>
                            <img src={Stock3} alt="Stock3" className="max-h-96 max-w-96 mx-auto z-0" />
                        </div>
                    </div>
                </div>
            </div>
